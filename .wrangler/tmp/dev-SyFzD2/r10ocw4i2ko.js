...
// .wrangler/tmp/pages-GRuEWV/bundledWorker-0.3764714306131993.mjs
...
var ce = /* @__PURE__ */ __name2((e, t, s, a) => {
  if (t && typeof t == "object" || typeof t == "function") for (let r of re(t)) !ie.call(e, r) && r !== s && G(e, r, { get: /* @__PURE__ */ __name2(() => t[r], "get"), enumerable: !(a = ne(t, r)) || a.enumerable });
  return e;
}, "ce");
var U = /* @__PURE__ */ __name2((e, t, s) => (s = e != null ? se(oe(e)) : {}, ce(t || !e || !e.__esModule ? G(s, "default", { value: e, enumerable: true }) : s, e)), "U");
var h;
var d = E(() => {
  h = { collectedLocales: [] };
});
...
function R(e, t, s) {
  ...
  let a = s ? "" : "i", r = [];
  return { match: (0, $.default)(`%${e}%${a}`, r).exec(t), captureGroupKeys: r };
}
__name(R, "R");
__name2(R, "R");
...
async function z(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let o = W(e, he), n = await a.get(r, { softTags: o });
      ...
      case "POST": {
        let o = globalThis[fe], n = /* @__PURE__ */ __name2(async () => {
          let i = await e.json();
          i.data.tags === void 0 && (i.tags ??= W(e, xe) ?? []), await a.set(r, i);
        }, "n");
...
__name2(W, "W");
function J() {
  globalThis[Y] || (ge(), globalThis[Y] = true);
}
__name(J, "J");
__name2(J, "J");
function ge() {
  ...
  globalThis.fetch = async (...t) => {
    ...
    return a || (a = await z(s), a) ? a : (Te(s), e(s));
  };
}
__name(ge, "ge");
__name2(ge, "ge");
...
function Ee() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name2((t, s) => e.has(s) ? e.get(s) : Reflect.get(globalThis, s), "get"), set: /* @__PURE__ */ __name2((t, s, a) => Me.has(s) ? Reflect.set(globalThis, s, a) : (e.set(s, a), true), "set") });
}
__name(Ee, "Ee");
__name2(Ee, "Ee");
...
// .wrangler/tmp/pages-GRuEWV/r10ocw4i2ko.js
...
// .wrangler/tmp/bundle-cj7Wki/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-cj7Wki/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=r10ocw4i2ko.js.map
